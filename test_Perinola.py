...
def test_tirar_valores_en_opciones():
   p = Perinola()
   opciones = ("Pone 1", "Toma 2", "Todos Ponen", "Toma 1", "Pone 2", "Toma Todo")
   for _ in range(1000):
       p.tirar()
...
def test_tirar_return():
   p = Perinola()
   caras_posibles = ("Pone 1", "Toma 2", "Todos Ponen", "Toma 1", "Pone 2", "Toma Todo")
   for _ in range(1000):
       resultado = p.tirar()
